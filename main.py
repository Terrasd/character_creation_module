...
def special(char_name: str, char_class: str) -> str:
    """Использование спец. умения персонажа."""
    if char_class == 'warrior':
    ...
    return f'{char_name} не применил спец умения'


def start_training(char_name: str, char_class: str) -> str:
    """Начало тренировки персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор персонажа игроком и описание этого персонажа."""
    approve_choice: str = ''
    char_class: str = ''
